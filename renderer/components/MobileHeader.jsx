...
//
// Schlanke mobile Kopfzeile (Capacitor): Logo + „Daskala". ToDos/Termine sind in
// den eigenen „Planer"-Bereich der Bottom-Navigation gewandert (kein Header-Symbol,
// kein Vollbild-Modal mehr).
