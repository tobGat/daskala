            ...
            <div className="space-y-6">
              ...
              <div>
                <h4 className="text-sm font-semibold text-ink-700 dark:text-paper-300 mb-1">
                  Ort für Wettervorschau <span className="font-normal text-ink-400">(optional)</span>
                </h4>
                <p className="text-xs text-ink-400 dark:text-ink-500 mb-2">
                  Macht die Wettervorschau im Stundenplan genauer. Ohne Angabe wird die Landeshauptstadt deines Bundeslands verwendet.
                </p>
                {wetterOrt ? (
