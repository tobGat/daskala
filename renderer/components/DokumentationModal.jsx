...
const DOKU = [
  ...
  },
  {
    id: 'schueler', titel: 'Schüler:innen', bloecke: [
      ...
      'Fächer je Person: In der Spalte „Fächer" öffnet „✎ Fächer" einen nach Klasse gruppierten Dialog. Dort ordnest du die Person einzelnen „Auswahl"-Fächern zu oder entfernst sie wieder; „ganze Klasse"-Fächer sind automatisch enthalten und daher nicht abwählbar.',
