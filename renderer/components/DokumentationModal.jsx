...
const DOKU = [
  ...
  },
  {
    id: 'kompetenzen', titel: 'Kompetenzen (Assistent & Netzdiagramm)', bloecke: [
      ...
      'Danach führt dich der Assistent Bereich für Bereich durch das Raster. Innerhalb jedes Kompetenzbereichs bewertest du jede Teilkompetenz mit einem Niveau von 0 bis 3 (0 = noch nicht erfasst; 1/2/3 = die Niveaustufen der Schulstufe). Die einzelnen Kann-Beschreibungen lassen sich je Teilkompetenz als Orientierung einblenden; eine Notiz ist optional. Zum Abschluss speicherst du – ein Durchlauf ergibt eine „Erhebung" zu diesem Zeitpunkt.',
      { h: 'Netzdiagramm & Verlauf' },
      'Das Netzdiagramm zeigt je Kompetenzbereich den Durchschnitt seiner Teilkompetenzen auf einen Blick. Mit dem Zeitstrahl-Schieber darunter wählst du den Erhebungszeitpunkt; das Diagramm wechselt animiert auf den jeweiligen Stand. Über „Details anzeigen" siehst du die einzelnen Teilkompetenzen mit ihrem Niveau zum gewählten Zeitpunkt. So wird die Entwicklung über das Schuljahr sichtbar.',
