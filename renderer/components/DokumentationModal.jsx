...
const DOKU = [
  ...
  },
  {
    id: 'kompetenzen', titel: 'Kompetenzen (Assistent & Netzdiagramm)', bloecke: [
      'Im Leistungsprofil kannst du pro Fach den Kompetenzstand einer:s Schüler:in mit einem Assistenten erfassen und die Entwicklung als Netzdiagramm verfolgen. Hinterlegt sind die Raster für Deutsch (Schulstufe 1–8), Englisch (5–8), die 1. lebende Fremdsprache der Primarstufe (1–4) sowie die Volksgruppensprachen Kroatisch/Slowenisch/Ungarisch (Schulstufe 3, 4, 7, 8).',
      'Ob ein Raster erscheint, erkennt Daskala am Fachnamen (z. B. „Deutsch", „Englisch", „Französisch"). Heißt ein Sprachfach anders – oder soll ein Fach als Volksgruppensprache geführt werden –, kannst du das Raster pro Fach zuordnen: Rechtsklick auf das Fach → „Kompetenzraster…" → Automatisch / Deutsch / Lebende Fremdsprache-Englisch / Volksgruppensprache / Keines. Kroatisch, Slowenisch oder Ungarisch werden automatisch als lebende Fremdsprache erkannt; für den Volksgruppen-Lehrplan wählst du hier „Volksgruppensprache".',
      { h: 'Assistent starten' },
      ...
      { tipp: 'Für Fächer ohne hinterlegtes Raster erscheint der Kompetenzen-Bereich nicht. Volksgruppensprachen verwenden EINE Skala mit drei Niveaus für alle (keine Standard/AHS-Unterscheidung); dort entfällt die Leistungsniveau-Auswahl.' },
    ],
  },
  {
