...
const DOKU = [
  ...
  },
  {
    id: 'schueler', titel: 'Schüler:innen', bloecke: [
      ...
      'Tabellen-Spalten: Über „Spalten ▾" oben rechts hakst du an, welche Informationen die Tabelle zeigt – Merkmale, Klassen, Fächer sowie einzelne Stammdaten (Telefon, Ort, Notfallnummer, …). Mit ▲/▼ ordnest du die Spalten (oben = weiter links). Die Auswahl bleibt bis zum Neustart erhalten. Im Bearbeiten-Fenster stehen Merkmale, SPF, Klassen und Fächer geordnet untereinander; Klassen und Fächer wählst du – wie SPF – über ein eigenes Fenster.',
      'Neue Schüler:innen anlegen (nur zentral): Über den Button „+ Neu" in der Schüler:innen-Verwaltung legst du Personen an – einzeln (mit Enter zügig hintereinander) oder per CSV-/Excel-Import; dabei wählst du die Stammklasse. Das Schüler:innen-Modal in der Klassenansicht legt keine neuen Personen mehr an: Dort fügst du unter „Hinzufügen" nur bereits vorhandene Schüler:innen des Schuljahrs der Klasse hinzu.',
