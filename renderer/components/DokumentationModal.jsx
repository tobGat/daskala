  ...
  },
  {
    id: 'noten', titel: 'Noten eintragen', bloecke: [
      ...
      { ul: [
        ...
        'MA – Mitarbeit: wahlweise zweistufig (+ / −) oder vierstufig als Smiley-Skala (😄 😞)',
        'HÜ – Hausübung (✓ gemacht / ✗ nicht gemacht / — nicht gewertet)',
      ] },
      'Beim Anlegen einer Mitarbeits-Spalte wählst du die Bewertungsskala: „Zweistufig" (+ verbessert, − verschlechtert) oder „Vierstufig" mit vier Smileys – 😄 sehr fröhlich (+0,1), 🙂 mäßig fröhlich (+0,05), 🙁 mäßig traurig (−0,05), 😞 sehr traurig (−0,1). Bei vierstufigen Spalten öffnet ein Klick auf die Zelle ein kleines Smiley-Auswahlfeld.',
