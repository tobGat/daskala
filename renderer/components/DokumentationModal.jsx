...
const DOKU = [
  ...
  },
  {
    id: 'benotung', titel: 'Benotung verstehen', bloecke: [
      ...
      'Innerhalb einer Kategorie (SA, Test, Individuell) kannst du neuere Leistungen stärker gewichten als frühere – so verlangt es § 20 LBVO („zuletzt erreichter Leistungsstand"). Über den Rezenz-Faktor (Einstellungen → Benotung) legst du fest, wie viel stärker die neueste Note zählt: 1,0 = alle gleich (reiner Durchschnitt), 2,0 = neueste zählt doppelt so stark wie die älteste. Sortiert wird nach dem Datum der Spalte; ohne Datum entscheidet die Reihenfolge. Beim ersten Start und nach dem einführenden Update wirst du einmalig gebeten, diesen Faktor festzulegen.',
