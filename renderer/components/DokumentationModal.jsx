...
const DOKU = [
  ...
  },
  {
    id: 'benotung', titel: 'Benotung verstehen', bloecke: [
      ...
      'Einzelne Mitarbeitsleistungen werden nicht einzeln benotet. Aus allen Aufzeichnungen entsteht eine einzige Mitarbeitsnote – der Durchschnitt der Teil-Einschätzungen. Bei reinem + / − entspricht das dem Verhältnis positiver zu negativer Einträge: ausgeglichen ergibt Note 3, nur „+" ergibt 1, nur „−" ergibt 5. Die dreistufige Skala steuert mit „~" die Mitte (Note 3) bei; die Smileys zählen intensitätsgewichtet (😄/😞 stärker als 🙂/🙁).',
      ...
      'Ein Klick auf eine Zeugnisnote öffnet ein Detail-Fenster. Dort siehst und änderst du alle Teilnoten dieses Fachs (Schularbeiten, Tests, Individuell, Mitarbeit, Hausübung) – die Zeugnisnote-Vorschau oben aktualisiert sich sofort. Du kannst die Note manuell überschreiben (und die Überschreibung wieder zurücksetzen); die berechnete Note bleibt darunter sichtbar. Außerdem stellst du hier den Rezenz-Faktor (§ 20) mit einem Schieberegler ein – eine Balken-Grafik zeigt live, wie stark neuere Leistungen zählen. Erst mit „OK" werden die Änderungen übernommen; hast du den Rezenz-Faktor verändert, fragt Daskala, ob er nur für diese:n Schüler:in oder für die ganze Klasse gelten soll.',
      { h: 'Zwischennote' },
