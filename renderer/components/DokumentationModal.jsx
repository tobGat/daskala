  ...
  },
  {
    id: 'noten', titel: 'Noten eintragen', bloecke: [
      ...
      { ul: [
        ...
        'MA – Mitarbeit: zweistufig als + / − oder ↗ / ↘, oder vierstufig als Smiley-Skala (😄 😞)',
        'HÜ – Hausübung (✓ gemacht / ✗ nicht gemacht / — nicht gewertet)',
      ] },
      'Beim Anlegen einer Mitarbeits-Spalte wählst du die Bewertungsskala: „+ / −", „↗ / ↘" (nur eine andere Darstellung von + / −, gleiche Bewertung) oder „Smileys" mit vier Stufen – 😄 sehr fröhlich, 🙂 mäßig fröhlich, 🙁 mäßig traurig, 😞 sehr traurig. Eine neue MA-Spalte übernimmt die zuletzt gewählte Variante. Bei Smiley-Spalten öffnet ein Klick auf die Zelle ein kleines Auswahlfeld.',
