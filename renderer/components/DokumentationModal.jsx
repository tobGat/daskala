...
const DOKU = [
  ...
  },
  {
    id: 'kompetenzen', titel: 'Kompetenzen (Assistent & Netzdiagramm)', bloecke: [
      'Im Leistungsprofil kannst du pro Fach den Kompetenzstand einer:s Schüler:in mit einem Assistenten erfassen und die Entwicklung als Netzdiagramm verfolgen. Hinterlegt sind die Raster für Deutsch (Schulstufe 1–8), Englisch (5–8) und die 1. lebende Fremdsprache der Primarstufe (1–4).',
      'Ob ein Raster erscheint, erkennt Daskala am Fachnamen (z. B. „Deutsch", „Englisch", „Französisch"). Heißt ein Sprachfach anders, kannst du das Raster pro Fach zuordnen: Rechtsklick auf das Fach → „Kompetenzraster…" → Automatisch / Deutsch / Fremdsprache / Keines.',
      { h: 'Assistent starten' },
