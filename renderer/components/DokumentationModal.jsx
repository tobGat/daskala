...
const DOKU = [
  ...
  },
  {
    id: 'schueler', titel: 'Schüler:innen', bloecke: [
      ...
      'Der Button „Schüler:innen" (neben „Dashboard") öffnet eine klassenübergreifende Gesamtliste aller Schüler:innen des Schuljahrs – mit Merkmalen (Lernschwäche/Legasthenie/SPF), Klassen- und Fächer-Zuordnung. Die Tabelle dient der Ansicht; ein Klick auf den Namen öffnet das Leistungsprofil. Zum Ändern klickst du „✎ Bearbeiten" am Zeilenende – ein eigenes Fenster bündelt Name, Merkmale sowie Klassen- und Fächer-Zuordnung und speichert alles auf einmal.',
      'Schüler:innen können mehreren Klassen angehören. So lassen sich klassenübergreifende Gruppen bilden: Lege ein Fach mit „Auswahl" statt „Ganze Klasse" an und wähle Personen aus beliebigen Klassen (im Auswahl-Dialog nach Klasse gruppiert, mit Live-Suche). Neu angelegte Personen werden global gespeichert und automatisch der aktiven Klasse zugeordnet.',
      ...
      'SPF je Fach: Ein Kind hat sonderpädagogischen Förderbedarf nicht zwingend in allen Fächern. Im Bearbeiten-Fenster hakst du im Abschnitt „SPF – je Fach" genau die Fächer an, in denen SPF gilt (der Schnell-Schalter „SPF" wählt alle Fächer aus bzw. ab). Der SPF-Badge erscheint dann nur in diesen Fächern (z. B. in der Notentabelle). SPF wird deshalb zentral hier gepflegt, nicht mehr im klassenspezifischen Schüler:innen-Modal.',
