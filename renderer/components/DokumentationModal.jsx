...
const DOKU = [
  ...
  },
  {
    id: 'noten', titel: 'Noten eintragen', bloecke: [
      ...
      'Bei der 4-stufigen Mitarbeit kannst du die Smileys je Spalte durch eigene Symbole ersetzen (z. B. +, +~, -~, -). Die Reihenfolge ist immer sehr positiv → sehr negativ, die Wertung entspricht genau den Smiley-Stufen. Die Symbole legst du beim Anlegen der Spalte fest und sind danach unveränderlich.',
