...
export const CHANGELOG = [
  {
    ...
    punkte: [
      ...
      'Fächer in der zentralen Verwaltung: Pro Schüler:in öffnet „✎ Fächer" einen nach Klasse gruppierten Dialog. Dort lassen sich einzelne „Auswahl"-Fächer an- und abwählen; „ganze Klasse"-Fächer ergeben sich automatisch aus der Klassenzugehörigkeit. Die Fächer-Spalte ist jetzt kompakt (erste Fächer + „+N").',
