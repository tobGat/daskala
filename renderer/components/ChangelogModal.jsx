...
export const CHANGELOG = [
  {
    ...
    punkte: [
      ...
      'Aufgeräumtes Bearbeiten-Fenster: Klassen- und Fächer-Zuordnung werden – wie schon SPF – in einem eigenen Auswahl-Fenster gewählt; im Bearbeiten-Fenster steht dafür nur noch die kompakte Übersicht mit „ändern".',
      'Spalten wählen: Über „Spalten ▾" in der Schüler:innen-Verwaltung blendest du ein, welche Informationen die Tabelle anzeigt (Merkmale, Klassen, Fächer sowie einzelne Stammdaten wie Telefon, Ort, Notfallnummer …). Die Auswahl bleibt bis zum Neustart erhalten.',
