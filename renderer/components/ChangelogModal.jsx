...
export const CHANGELOG = [
  {
    ...
    punkte: [
      ...
      'Tabelle in der Schüler:innen-Verwaltung: Vor- und Nachname stehen jetzt in eigenen Spalten und sind per Klick auf die Spaltenüberschrift sortierbar (auf-/absteigend). Zusätzlich lässt sich oben nach Klasse und nach Merkmalen (LS/LEG/SPF) filtern.',
