...
- **Stundenplan bearbeiten mobil** [Stundenplan.jsx](../renderer/components/Stundenplan.jsx): ein
  **Stift-FAB** unten rechts schaltet den Bearbeitungsmodus um (wird zum korallenroten ✓). Im
  Bearbeitungsmodus erscheint oben ein Hinweis-Band mit Zugriff auf „🕐 Zeiten"; leere Zellen zeigen
  „+", ein Tap öffnet „Stunde belegen", ein Tap auf eine belegte Stunde öffnet „Stunde bearbeiten".
  (Drag-&-Drop zum Verschieben bleibt Desktop-only – am Touch stattdessen über das Belegen/Ändern.)
