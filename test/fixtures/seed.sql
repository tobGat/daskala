...
INSERT INTO kompetenz_erhebung_werte (id, erhebung_id, bereich_idx, teilkompetenz_idx, bereich_name, teilkompetenz_name, niveau, notiz) VALUES
  (1, 1, 0, 0, 'Lesen',     'Lesefertigkeit', 1, NULL),
  (2, 1, 1, 0, 'Schreiben', 'Verfassen',      2, 'ok'),
  (3, 2, 0, 0, 'Lesen',     'Lesefertigkeit', 2, NULL),
  (4, 2, 1, 0, 'Schreiben', 'Verfassen',      3, NULL);
