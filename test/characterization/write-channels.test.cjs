...
const CASES = [
  ...
  { name: 'zeugnisnoten:setManuell', channel: 'zeugnisnoten:setManuell', args: [1, 3, 1, '2'], tables: ['zeugnisnoten'] },
  { name: 'zeugnisnoten:clearManuell', channel: 'zeugnisnoten:clearManuell', args: [1, 2, 2], tables: ['zeugnisnoten'] },
  { name: 'zeugnisnoten:berechne', channel: 'zeugnisnoten:berechne', args: [1, 1, 1], tables: ['zeugnisnoten'] },
