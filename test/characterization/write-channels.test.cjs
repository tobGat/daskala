...
const CASES = [
  ...
  { name: 'kompetenzErhebungen:speichern', channel: 'kompetenzErhebungen:speichern', args: [{ schuelerId: 1, fachId: 1, schulstufe: 3, datum: '2026-01-15', titel: 'Mitte', werte: [{ bereich_idx: 0, teilkompetenz_idx: 0, item_idx: 0, bereich_name: 'Lesen', teilkompetenz_name: 'Lesefertigkeit', niveau: 2 }, { bereich_idx: 1, teilkompetenz_idx: 0, item_idx: 0, bereich_name: 'Schreiben', teilkompetenz_name: 'Verfassen', niveau: 1, notiz: 'x' }] }], tables: ['kompetenz_erhebungen', 'kompetenz_erhebung_werte'] },
